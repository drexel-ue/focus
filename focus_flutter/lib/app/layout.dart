...
/// SizedBox(height: 50.0 + 20.0 + 20.0)
const segmentedControlMargin = SizedBox(height: 50.0 + 20.0 + 20.0);
...
const horizontalPadding10 = EdgeInsets.symmetric(horizontal: 10.0);
...
const horizontalPadding28 = EdgeInsets.symmetric(horizontal: 28.0);
...
const horizontalPadding44 = EdgeInsets.symmetric(horizontal: 44.0);
...
const verticalPadding14 = EdgeInsets.symmetric(vertical: 14.0);

/// EdgeInsets.symmetric(vertical: 16.0)
const verticalPadding16 = EdgeInsets.symmetric(vertical: 16.0);

/// EdgeInsets.symmetric(vertical: 18.0)
const verticalPadding18 = EdgeInsets.symmetric(vertical: 18.0);
...
/// EdgeInsets.all(1.0)
const allPadding1 = EdgeInsets.all(1.0);
...
/// EdgeInsetsDirectional.only(end: 32.0)
const endPadding32 = EdgeInsetsDirectional.only(end: 32.0);

/// EdgeInsetsDirectional.only(end: 48.0)
const endPadding48 = EdgeInsetsDirectional.only(end: 48.0);

// BorderRadius ===========================================================================

/// BorderRadius.all(Radius.circular(4.0))
const borderRadiusAll4 = BorderRadius.all(Radius.circular(4.0));

/// BorderRadius.all(Radius.circular(10.0))
const borderRadiusAll10 = BorderRadius.all(Radius.circular(10.0));

/// BorderRadius.all(Radius.circular(12.0))
const borderRadiusAll12 = BorderRadius.all(Radius.circular(12.0));

/// BorderRadius.all(Radius.circular(24.0))
const borderRadiusAll24 = BorderRadius.all(Radius.circular(24.0));
